    ...
    <div>
        ...
        <div class="blogsList">
            ...
            <ol class="blogsList__list">
                <ArticleFilteredForTag v-for="article in getArticlesList" :key="article.id" :article="article" />
            </ol>
            <img class="blogImg blogsList__img" :src="require('@/assets/img/blogDetails2.png')"  alt="blog" />
            <p class="blogsList__text">
                Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae
                turpmaximus.posuere in.Contrary to popular belief.There are many
                variations of passages of Lorem Ipsum available, but the majority
